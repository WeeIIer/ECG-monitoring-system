...
class Ui_ecg_simulator_window(object):
    def setupUi(self, ecg_simulator_window):
        ...
        ecg_simulator_window.resize(661, 638)
        ...
        self.list_ecg_leads.setMaximumSize(QtCore.QSize(50, 16777215))
        ...
        item = QtWidgets.QListWidgetItem()
        self.list_ecg_leads.addItem(item)
        self.horizontalLayout_3.addWidget(self.list_ecg_leads)
        self.text_ecg_info = QtWidgets.QTextEdit(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.text_ecg_info.sizePolicy().hasHeightForWidth())
        self.text_ecg_info.setSizePolicy(sizePolicy)
        self.text_ecg_info.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.text_ecg_info.setReadOnly(True)
        self.text_ecg_info.setObjectName("text_ecg_info")
        self.horizontalLayout_3.addWidget(self.text_ecg_info)
