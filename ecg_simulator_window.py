...
class Ui_ecg_simulator_window(object):
    def setupUi(self, ecg_simulator_window):
        ...
        ecg_simulator_window.resize(724, 662)
        ...
        self.button_generate = QtWidgets.QPushButton(self.groupBox_4)
        ...
        self.button_generate.setMinimumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.button_generate.setFont(font)
        self.button_generate.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.button_generate.setIconSize(QtCore.QSize(24, 24))
        self.button_generate.setObjectName("button_generate")
        self.horizontalLayout_10.addWidget(self.button_generate)
        ...
        item = QtWidgets.QListWidgetItem()
        self.list_ecg_content.addItem(item)
        self.horizontalLayout_3.addWidget(self.list_ecg_content)
        self.verticalLayout_22 = QtWidgets.QVBoxLayout()
        self.verticalLayout_22.setSpacing(5)
        self.verticalLayout_22.setObjectName("verticalLayout_22")
        self.text_ecg_info = QtWidgets.QTextEdit(self.groupBox_3)
        self.text_ecg_info.setObjectName("text_ecg_info")
        self.verticalLayout_22.addWidget(self.text_ecg_info)
        self.button_ecg_blabla = QtWidgets.QPushButton(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_ecg_blabla.sizePolicy().hasHeightForWidth())
        self.button_ecg_blabla.setSizePolicy(sizePolicy)
        self.button_ecg_blabla.setMinimumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.button_ecg_blabla.setFont(font)
        self.button_ecg_blabla.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.button_ecg_blabla.setIconSize(QtCore.QSize(24, 24))
        self.button_ecg_blabla.setObjectName("button_ecg_blabla")
        self.verticalLayout_22.addWidget(self.button_ecg_blabla)
        ...
        self.edit_heart_rhythm.setReadOnly(False)
        ...
        self.edit_heart_rate.setReadOnly(False)
        ...
        self.edit_pacemaker = QtWidgets.QLineEdit(self.groupBox)
        self.edit_pacemaker.setMinimumSize(QtCore.QSize(0, 21))
        self.edit_pacemaker.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.edit_pacemaker.setReadOnly(False)
        self.edit_pacemaker.setObjectName("edit_pacemaker")
        self.verticalLayout_20.addWidget(self.edit_pacemaker)
        ...
        self.edit_heart_axis.setReadOnly(False)
    ...
    def retranslateUi(self, ecg_simulator_window):
        ...
        self.button_generate.setText(_translate("ecg_simulator_window", "Генерировать"))
        ...
        self.groupBox_3.setTitle(_translate("ecg_simulator_window", "Элементы ЭКГ"))
        ...
        self.button_ecg_blabla.setText(_translate("ecg_simulator_window", "button"))
        self.groupBox.setTitle(_translate("ecg_simulator_window", "Основная информация"))
        ...
        self.label_15.setText(_translate("ecg_simulator_window", "Водитель сердечного ритма"))
